...
```bash
git clone https://github.com/profe-benja/gymflow-maps
```
...
4. (no es necesario) Crea un superusuario para acceder al panel de administración (sigue las instrucciones en la consola):
